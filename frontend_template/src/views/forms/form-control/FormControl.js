    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../form-control#sizing">
              <CFormInput
                type="text"
                size="lg"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../form-control#disabled">
              <CFormInput
                type="text"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../form-control#readonly">
              <CFormInput
                type="text"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample href="../form-control#file-input">
              <div className="mb-3">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample href="../form-control#color">
