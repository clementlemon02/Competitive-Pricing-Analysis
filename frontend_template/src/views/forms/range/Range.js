      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../range" tabContentClassName="bg-opacity-10">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../range#disabled" tabContentClassName="bg-opacity-10">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../range#min-and-max" tabContentClassName="bg-opacity-10">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="../range#steps" tabContentClassName="bg-opacity-10">
